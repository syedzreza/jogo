                ...
                <div class="right-side log-sign-in">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="login-tab" data-toggle="tab" href="#login" role="tab" aria-controls="login" aria-selected="true">New Password</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
                            <form action="{{route('submitforgetpassword',['id'=>$id])}}" method="post">
                                {{@csrf_field()}}
                                ...
                                {{--<div class="form-group">--}}
                                    {{--<input type="password" class="form-control" name="confirm_password" id="password" placeholder="Confirn Password">--}}
                                {{--</div>--}}
                                <button type="submit" id="update" class="btn1">Update</button>
                            </form>
                        </div>
                    </div>
                </div>
