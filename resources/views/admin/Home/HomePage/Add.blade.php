...
@section('content')
    <div id="content" class="content">
        ...
        <!-- begin page-header -->
        <h1 class="page-header">Add Home Page</h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="{{route('admin::saveHomePage')}}" method="post">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="button_name" placeholder="Enter Your Shop" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="delivery" placeholder="Enter Your Delivery" />
                                </div>
                            </div>
                            <div class="form-group">
