        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div style="padding: 10px;"><a  class="btn btn-success  fancybox fancybox.iframe"  style="float: right;margin-bottom: 10px" href="{{route('admin::addUser')}}"><i class="fa fa-plus"></i> Add</a></div>
                            ...
                            <tr class="{{$class}}">
                                ...
                                <td>
                                    <span id="status{{$user->id}}">
                                        ...
                                        <a href="{{route('admin::editUserForm',['id'=>$user->id])}}" class="fancybox fancybox.iframe btn btn-primary"><span class="glyphicon glyphicon-edit"></span></a>&emsp;
                                        <a data-toggle="modal" data-target="#confirmDelete" class="btn btn-danger" onclick="getDeleteRoute('{{route('admin::delUser',['id'=>$user->id])}}')"><span class="glyphicon glyphicon-trash"></span></a>&emsp;
